  ...
  implements ComponentFramework.StandardControl<IInputs, IOutputs>
{
  ...
  private props: ICalendarAndTimeProps = {
    ...
    showAsDialog: true,
    showAsAmPM: false,
    selectedDate: new Date(0, 0, 0, 0, 0),
  ...
  public init(
    ...
    this.props.minuteStepper = context.parameters.TimePickerMinuteStepper
      .raw as number;
    this.props.primaryColorCode = context.parameters.PrimaryColor.raw as string;
    this.props.secondaryColorCode = context.parameters.SecondaryColor
      .raw as string;
    ...
    this.props.selectedDate.setMinutes(30);
    this.props.showAsDialog = context.parameters.Dialog.raw as boolean;
    this.props.showAsAmPM = context.parameters.AmPm.raw as boolean;
  ...
  public updateView(context: ComponentFramework.Context<IInputs>): void {
    ...
    // Add code to update control view
    ReactDOM.render(
      React.createElement(MaterialTimePicker, this.props),
      this.theContainer
    );
  }
