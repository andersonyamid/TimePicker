...
export interface ICalendarAndTimeState
  extends React.ComponentState,
    ICalendarAndTimeProps {
  personaSize: number;
...
export class MaterialTimePicker extends React.Component<
  ICalendarAndTimeProps,
  ICalendarAndTimeState
> {
        ...
        <ThemeProvider theme={defaultMaterialTheme}>
          <MuiPickersUtilsProvider utils={DateFnsUtils}>
            <TimePicker
              ...
              ampm={this.props.showAsAmPM ? true : false}
